...
<div class="logotip">
    ...
    <ul class="slides">
      <li>
        <img src="img/astralis-slider.jpg"> <!-- random image -->
      </li>
      <li>
        <img src="img/gambit-slider.jpg"> <!-- random image -->
      </li>
      <li>
        <img src="img/VP=slider.jpg"> <!-- random image -->
      </li>
    </ul>
  </div></div>
      <div class="col s5" id="textn">Стартовый этап развития мейджоров начался с DreamHack Winter 2013 и закончился тем же турниром, только в 2014 году. Major-ивенты проходили на небольших площадках, игровое сообщество еще начинало формироваться, а трансляции CS:GO только набирали обороты. Valve продолжила работать с краудфандинговой системой, выпустив после этого еще два кейса — Esports 2013 Winter Case и Esports 2014 Summer Case, но призовой фонд оставался на прежней отметке – $250 000.</div>
...
<div class="logotip">
    ...
    <ul class="slides">
      <li>
        <img src="img/dota-slider1.jpg"> <!-- random image -->
      </li>
      <li>
        <img src="img/dota-slider2.jpg"> <!-- random image -->
      </li>
      <li>
        <img src="img/dota-slider 3.jpg"> <!-- random image -->
      </li>
      <li>
        <img src="img/dota-slider4.jpg"> <!-- random image -->
      </li>
    </ul>
  </div></div>
